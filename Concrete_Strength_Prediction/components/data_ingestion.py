...
from Concrete_Strength_Prediction.data_access.mongo_data import mongodata
...
from Concrete_Strength_Prediction.constant.database import DATABASE_NAME,COLLECTION_NAME
